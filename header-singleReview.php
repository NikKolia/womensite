...
<body <?php body_class(); ?>>  
  <section class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top container-fluid bgPurple">
    ...
    wp_nav_menu( array(
      ...
      'depth' => 2,
      'container' => false,
      'menu_class' => 'navbar-nav ml-auto mt-2 mt-lg-0 text-uppercase reviewsMenu',
